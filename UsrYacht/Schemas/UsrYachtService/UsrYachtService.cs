    ...
    public class YachtService : BaseService, IReadOnlySessionState
    {
        ...
        public decimal GetMaxPriceByDriveTypeId(string driveTypeId)
        {
            ...
            Select select = new Select(UserConnection)
                ...
                .From("UsrYachts")
                .Where("UsrDeviceTypeId").IsEqual(Column.Parameter(new Guid(driveTypeId)))
                .And("UsrStatusId").IsEqual(Column.Parameter(new Guid("24e7b47f-7193-4fb0-8d4f-c8d3e3d09dc3")))
                as Select;
